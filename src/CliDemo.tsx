...
const commands = [
    ...
    { text: '🚀 AI-SHIP Git Intelligence CLI', delay: 1500, type: 'title' },
    { text: '✓ Staged all changes.', delay: 2500, type: 'success' },
    { text: '✓ Found 5 staged file(s).', delay: 3500, type: 'success' },
    { text: 'Files changed:', delay: 4000, type: 'info' },
    { text: '✓ + README.md', delay: 4200, type: 'added' },
    { text: '✓ + ai-ship-review.html', delay: 4400, type: 'added' },
    { text: '✓ + src/commands/git/startReview.ts', delay: 4600, type: 'added' },
    { text: '✓ + src/utils/git.ts', delay: 4800, type: 'added' },
    { text: '✓ + src/utils/reviewUtils.ts', delay: 5000, type: 'added' },
    { text: '✓ Analysis complete.', delay: 6500, type: 'success' },
    { text: '✓ Commit message generated:\\n', delay: 7000, type: 'success' },
    { text: 'feat: add code review capability', delay: 7500, type: 'message' },
    ...
    { text: '✓ Analysis complete.\\n', delay: 10500, type: 'success' },
    { text: '✓ Branch name generated:\\n', delay: 11000, type: 'success' },
    { text: 'feature/addcodereview', delay: 11500, type: 'message' },
    { text: '? What would you like to do with this branch name? Continue', delay: 13000, type: 'prompt' },
    { text: '✓ Checked out to feature/addcodereview!', delay: 14000, type: 'success' },
    ...
    { text: '✓ GitHub PR created successfully!', delay: 23000, type: 'success' },
    { text: 'ℹ PR Link: https://github.com/developer-diganta/ai-ship/pull/18', delay: 24000, type: 'link' }
];

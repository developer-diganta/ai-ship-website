import { Terminal, Puzzle, ArrowRight, ArrowUpRight, Github, Code2, Sparkles, GitPullRequest, GitBranch, Zap, CheckCircle2, Cpu, Rocket, Server } from 'lucide-react';
...
export function Landing() {
  ...
  return (
    <div className="max-w-5xl mx-auto w-full px-6 pt-24 pb-32">
        {/* Header Section */}
        <motion.section
          initial="hidden"
          animate="visible"
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4 pt-8">
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
              className="rounded-lg shadow-[0_0_30px_rgba(255,255,255,0.2)]"
            >
              <Link
                to="/docs"
                className="h-12 px-6 rounded-lg bg-white text-black font-semibold text-lg hover:bg-gray-100 transition-colors flex items-center"
              >
                Get Started
        ...
        >
          ...
          <div className="p-12 md:p-16 rounded-3xl bg-vercel-gray-100/50 border border-vercel-gray-200/50 backdrop-blur-md text-center overflow-hidden relative">
            ...
            >
              <Link
                to="/docs"
                className="h-14 px-8 w-fit rounded-full bg-gradient-to-r from-accent-blue to-accent-purple text-white font-bold text-lg transition-all flex items-center mx-auto"
              >
                Get Started
